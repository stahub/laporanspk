...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="" target="">Docs</a>
            </li>
            <li class="menu-item hidden"><a href=""target="">Community</a></li>
            <li class="menu-item hidden"><a
            href="" target="">Contribute</a>
            </li>
        </ul>
    </div>
...
<section>
    ...
    <form action="" method="post">
        ...
        <div class="container" style="background-color:#f1f1f1">
            <span class="psw">Forgot <a href="https://t.me/inyndra">password?</a></span>
        </div>
    </form>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> staaDev with CodeIgniter Foundation. CodeIgniter is open source project released under the MIT
